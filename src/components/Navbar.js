...
export default function Navbar() {
  ...
  return (
    <>
      {/* LOGIN NOTICE */}
      {!loadingUser && !user && (
        <div className="text-center py-2" style={{ background: "#e8f0ff" }}>
          🔐 Please Login with Google to access your profile & features
        </div>
      )}
        ...
        <div className="container">
          ...
          <ul className="navbar-nav ms-auto d-none d-lg-flex flex-row gap-4 align-items-center mb-0">
            ...
            <li className="nav-item dropdown">
              {loadingUser ? (
                <span className="text-muted small">Checking login...</span>
              ) : !user ? (
                <a
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end shadow-sm p-2" style={{ width: "240px" }}>

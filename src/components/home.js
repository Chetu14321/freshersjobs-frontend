...
import { Briefcase, GraduationCap, FileSearch, Home, Info, Mail, ShieldCheck, FileText } from "lucide-react";

const cardData = [
  { title: "Jobs", description: "Explore the latest job openings and start your career.", icon: Briefcase, link: "/jobs", color: "primary" },
  { title: "Internships", description: "Find internships that will give you real-world experience.", icon: GraduationCap, link: "/internships", color: "success" },
  { title: "Resume ATS Finder", description: "Check your resume compatibility with ATS and improve your chances.", icon: FileSearch, link: "/resume-checker", color: "warning" },
];

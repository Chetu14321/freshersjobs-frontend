  ...
  return (
    <div className="py-5 bg-light min-vh-100">
      <div className="container">
        ...
        {/* Main Job Card */}
        <div className="card shadow-sm border-0 rounded-4 mb-5 p-4 p-md-5 fade-up">
          {job.banner && (
            <img
              src={job.banner}
              alt="Job Banner"
          ...
          <div className="text-center mb-4">
            ...
            <h4 className="text-secondary">{job.company}</h4>
          </div>
          ...
          <div className="table-responsive mb-4">
            <table className="table table-bordered">
              <tbody>
                ...
                <tr><th>Job Location</th><td>{job.location||"-"}</td></tr>
          ...
          <div className="text-secondary" style={{lineHeight:"1.7"}} dangerouslySetInnerHTML={{__html: job.description}}></div>
          ...
          <div className="mt-5">
            ...
            <div className="row g-4">
              {relatedJobs.map((rJob,i) => (
                <div key={rJob._id} className="col-md-6 col-lg-4 job-card" style={{animationDelay:`${i*0.2}s`}}>
                  <div
                  ...
                  >
                    <div className="card-body d-flex flex-column">
                      <h5 className="card-title fw-bold">{rJob.title}</h5>
                      <h6 className="card-subtitle mb-2 text-muted">{rJob.company}</h6>
                      <div className="mb-3">
                        <span className="badge" style={{backgroundColor:"#2980b9", color:"#fff"}}>{rJob.location}</span>
                        {rJob.isWFH && <span className="badge ms-2" style={{backgroundColor:"#27ae60", color:"#fff"}}>Remote</span>}
                      </div>
                      <Link
                        to={`/job/${rJob._id}`}
                        className="btn mt-auto"
                        style={{backgroundColor:"#34495e", color:"#fff", borderRadius:"50px"}}
                      >
                        View Details
                      </Link>
                    </div>
